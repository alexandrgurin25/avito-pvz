...
func (m *MockRepository) CreateUser(ctx context.Context, email, passwordHash, role string) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) CreateUser(ctx, email, passwordHash, role any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateUser", reflect.TypeOf((*MockRepository)(nil).CreateUser), ctx, email, passwordHash, role)
}
